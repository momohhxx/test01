...
# i comment out below to save importing time
'''
...
# below is just the fisher information, which is negative 2nd derivative
# of the log-likelihood function (derive using taylor series)
